...
public class Menu {
    ...
    public void getMenu(StudentService studentService, CourseService courseService, GroupService groupService)
            throws DaoException {
        ...
        while (!input.equals("quit")) {
            if (input.equals("a")) {
                ...
                for (Group group : groupService.findGroupsByStudentsCount(number)) {
                    System.out.println(group.getName());
                }
            } else if (input.equals("b")) {
                System.out.println("enter course's id");
                int courseId = scanner.nextInt();
                for (Student student : studentService.findAllByCourse(courseId)) {
